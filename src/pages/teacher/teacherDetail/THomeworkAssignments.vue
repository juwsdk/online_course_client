              ...
              <el-container direction="vertical" style="padding: 0">
                <el-main height="200px">
                  ...
                  <el-form-item label="信息">
                    <el-input
                      type="textarea"
                      v-model="fileItem.courseHomeworkDescription"
                    ></el-input>
                  </el-form-item>
                </el-main>
              </el-container>
...
import { uploadHomework } from "@/api/teacher/homeworkApi";
        ...
        .then(() => {
          this.fileList.forEach((fileItem) => {
            ...
            formData.append(
              ...
              fileItem.courseHomeworkDescription
            );
